...
const translations = {
  he: {
    ...
    "high_deduction": "ניכוי לשעה (גבוה) - ש\"ח",
    ...
    "threshold_deduction_hint": "מתחת לסף זה, יחול הניכוי הגבוה.",
  ...
  en: {
    ...
    "high_deduction": "Deduction/Hr (High) - NIS",
    ...
    "threshold_deduction_hint": "Below this threshold, high deduction applies.",
